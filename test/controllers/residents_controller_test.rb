...
class ResidentsControllerTest < ActionController::TestCase
  ...
  test "should create resident" do
    assert_difference('Resident.count') do
      post :create, resident: { email: @resident.email, house_number: @resident.house_number, resident_name: @resident.resident_name, telephone: @resident.telephone }
    end
  ...
  test "should update resident" do
    patch :update, id: @resident, resident: { email: @resident.email, house_number: @resident.house_number, resident_name: @resident.resident_name, telephone: @resident.telephone }
    assert_redirected_to resident_path(assigns(:resident))
  end
